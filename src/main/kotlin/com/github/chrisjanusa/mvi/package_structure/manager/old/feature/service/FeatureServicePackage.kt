...
import com.github.chrisjanusa.mvi.package_structure.manager.old.feature.service.mapper.FeatureMapperPackage
import com.github.chrisjanusa.mvi.package_structure.manager.old.feature.service.remote.FeatureRemotePackage
import com.github.chrisjanusa.mvi.package_structure.manager.old.feature.service.remote.FeatureRemoteWrapperPackage
import com.github.chrisjanusa.mvi.package_structure.manager.old.feature.service.repository.FeatureRepositoryPackage
...
class FeatureServicePackage(file: VirtualFile): PackageManager(file), FeatureDirectChild {
    ...
    companion object : StaticExcludeChildInstanceCompanion("service", CommonPackage) {
        ...
        fun createNewInstance(insertionPackage: FeaturePackage): FeatureServicePackage? {
            return FeatureServiceModule.createNewInstance(insertionPackage)
        }
    }
}